...
contract test {
    ...
    address BDD = 0xd9145CCE52D386f254917e481eB44e9943F39138;
     
    uint256 public balance1 = IERC20(BDD).balanceOf(0x5B38Da6a701c568545dCfcB03FcB875f56beddC4);
    

    //USDT稳定币合约导入
    IERC20 usdtInterface = IERC20(BDD);
  ...
  function BURN(address ad,uint256 amount) public{
      usdtInterface.burn(ad,amount);
  }
